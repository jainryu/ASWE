...
class Test_TestThumbtack:

    def test_create_test_data(self):
        return_dict = create_test_data()
        assert test_lead_dict == return_dict
    ...
    def test_thumbtack_lead_json_to_list(self):
        ...
        assert correct_data_list == data_list
        assert correct_column_list == column_list
    ...
    def test_thumbtack_send_message(self):
        assert test_thumbtack_send_message("286845156044809661", "299614694480093245", "Hello John, how can I help you?") == 200
