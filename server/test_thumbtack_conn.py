...
class Test_Thumbtack(unittest.TestCase):
    ...
    def test_create_test_data(self) -> None:
        ...
        self.assertEqual(self.test_lead_dict["price"], return_dict["price"])

    def test_thumbtack_lead_json_to_list(self) -> None:
        """
        Test converting the thumbtack lead json into a list

        :return None
        """
        data_list, column_list = thumbtack_lead_json_to_list(self.test_lead_dict)
    ...
    def test_thumbtack_message_json_to_list(self) -> None:
        """
        Test converting the thumbtack message json into a list

        :return None
        """
        data_list, column_list = thumbtack_message_json_to_list(self.test_message_dict)
    ...
    def test_thumbtack_send_message(self) -> None:
        """
        Test sending a thumbtack message

        :return None
        """
        self.assertEqual(thumbtack_send_message("286845156044809661", "299614694480093245", "Hello John, how can I help you?"), 200)
